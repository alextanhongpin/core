...
// 	// Override Event methods to track call order
// 	originalLog := logHandler.Event
// 	originalMetric := metricHandler.Event
// 	originalTrace := traceHandler.Event

// 	logHandler.Event = func(ctx context.Context, e *event.Event) context.Context {
// 		callOrder = append(callOrder, "log")
// 		return originalLog(ctx, e)
// 	}

// 	metricHandler.Event = func(ctx context.Context, e *event.Event) context.Context {
// 		callOrder = append(callOrder, "metric")
// 		return originalMetric(ctx, e)
// 	}

// 	traceHandler.Event = func(ctx context.Context, e *event.Event) context.Context {
// 		callOrder = append(callOrder, "trace")
// 		return originalTrace(ctx, e)
// 	}
...
// 	assert.Equal(t, []string{"log", "metric", "trace"}, callOrder)
// }
