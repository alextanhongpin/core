...
func TestChain(t *testing.T) {
	...
	chain.Handler(h, mockMiddleware(rec, "first"), mockMiddleware(rec, "second")).ServeHTTP(w, r)
...
func TestChainFunc(t *testing.T) {
	...
	chain.HandlerFunc(h, mockMiddlewareFunc(rec, "first"), mockMiddlewareFunc(rec, "second"))(w, r)
...
func mockMiddleware(rec *recorder, msg string) chain.Middleware {
...
func mockMiddlewareFunc(rec *recorder, msg string) chain.MiddlewareFunc {
